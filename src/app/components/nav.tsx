...
export default function Nav() {
  return (
    <nav className="flex gap-5 bg-transparent p-2">
      <Link href="/inicio" className="flex flex-col items-center hover:shadow p-2">
      ...
      <Link href="/turmas" className="flex flex-col items-center hover:shadow p-2">
      ...
      <Link href="/frequencia" className="flex flex-col items-center hover:shadow p-2">
